...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    ...
    <div class="kt-portlet">
        ...
        @if(Auth::user()->hasRole('dev'))
            <!--begin::Form-->
            <form class="kt-form" method="POST" action="{{ url('checkout-dev') }}" enctype="multipart/form-data"  role="search" autocomplete="off" id="receivingForm">
                    {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <input type="password" id="codes" class="form-control-lg col-lg-12" name="codes" required autofocus style="height:150px; border: 1px solid #999;">                                    </div>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        @elseif(Auth::user()->hasRole('admin'))
            <!--begin::Form-->
            <form class="kt-form" method="POST" action="{{ url('checkout-admin') }}" enctype="multipart/form-data"  role="search" autocomplete="off" id="receivingForm">
                    {{ csrf_field() }}
