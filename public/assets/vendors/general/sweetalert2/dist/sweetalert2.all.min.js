!(function(t, e) {
    ...
    var P,
        ...
        gt = function(t) {
            ...
            S(r, t.customClass, "header"),
                ...
                (function(t) {
                    var e = z();
                    if (e && e.classList.contains(g[t.type]))
                        S(e, t.customClass, "icon");
                    else if ((pt(), t.type))
    ...
    var Ft = function(t) {
            ...
            null !== t.onBeforeOpen &&
                ...
                t.onBeforeOpen(n),
                t.animation
                    ? (O(n, x.show), O(e, x.fade), T(n, x.hide))
                    : T(n, x.fade),
                j(n),
                (e.style.overflowY = "hidden"),
                lt && !y(n, x.noanimation)
                    ? n.addEventListener(lt, function t() {
                          n.removeEventListener(lt, t),
                ...
                return new Promise(function(t) {
                    ...
                    if (
                        ...
                        f.toast ||
                                        ...
                                        if ("Tab" === t.key) {
                                            ...
                                            [
                                                ...
                                                : ("Escape" !== t.key &&
                                                  ...
                                                  (t.preventDefault(),
                                                  s(g.DismissReason.esc));
                                    else if (
                                        t.target &&
                                        p.getInput() &&
                                        t.target.outerHTML ===
                                            p.getInput().outerHTML
                                    ) {
                                        if (
                                            -1 !==
                            ...
                            (yt.keydownTarget = f.keydownListenerCapture
                                ? window
                                : m.popup),
                            (yt.keydownListenerCapture =
                                f.keydownListenerCapture),
